...
const HeroSection = () => {
  return (
    ...
    <div className="relative flex min-h-screen items-end justify-center" id="hero">
        <motion.img src={profilePic} alt={PROFILE.name} className="absolute inset-0 z-10 h-full w-full
         object-cover"
         initial={{ opacity:0 }}
         animate={{opacity:1}}
        ...
        className="z-20 mx-4 max-w-3xl pb-20 pr-5">
            <h1 className="text-5xl font-semibold uppercase tracking-wide md:text-6xl">
                {PROFILE.name}
            </h1>
